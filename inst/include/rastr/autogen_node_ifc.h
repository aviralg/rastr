...
// rep
rastr_node_t
rastr_pars_rep(rastr_ast_t ast, rastr_node_t node, int index, rastr_node_t par);
...
// rep
rastr_node_t
rastr_args_rep(rastr_ast_t ast, rastr_node_t node, int index, rastr_node_t arg);
