...
#line 193 "Parser.hxx"
  ...
  public:
    ...
    LPAREN = 258,                  // LPAREN
    RPAREN = 259,                  // RPAREN
    RSQPAREN = 260,                // RSQPAREN
    LBRACE = 261,                  // LBRACE
    RBRACE = 262,                  // RBRACE
    EXCLAMATION = 263,             // EXCLAMATION
    NEWLINE = 264,                 // NEWLINE
    DOUBLE_EXCLAMATION = 265,      // DOUBLE_EXCLAMATION
    COMMA = 266,                   // COMMA
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_LPAREN = 3,                            // LPAREN
        S_RPAREN = 4,                            // RPAREN
        S_RSQPAREN = 5,                          // RSQPAREN
        S_LBRACE = 6,                            // LBRACE
        S_RBRACE = 7,                            // RBRACE
        S_EXCLAMATION = 8,                       // EXCLAMATION
        S_NEWLINE = 9,                           // NEWLINE
        S_DOUBLE_EXCLAMATION = 10,               // DOUBLE_EXCLAMATION
        S_COMMA = 11,                            // COMMA
